...
--
-- 1. maza_learning_proposals.severidade
...
--
-- 2. maza_intelligence_scores.score_oficial + cap_razao
...
ALTER TABLE maza_learning_proposals
  ADD COLUMN IF NOT EXISTS severidade text
  CONSTRAINT maza_learning_proposals_severidade_check
...
ALTER TABLE maza_intelligence_scores
  ...
  CONSTRAINT maza_intelligence_scores_score_oficial_check
...
CREATE INDEX IF NOT EXISTS idx_klp_modulo_sev_pending
  ON maza_learning_proposals (modulo, severidade)
