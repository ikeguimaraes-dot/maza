...
const ZONES = [
  { prefixes: ["/financeiro"], env: "FINANCEIRO_APP_URL", fallback: "https://kph-os-financeiro.vercel.app" },
  { prefixes: ["/pessoas"], env: "PESSOAS_APP_URL", fallback: "https://kph-os-pessoas.vercel.app" },
  { prefixes: ["/operacao"], env: "OPERACAO_APP_URL", fallback: "https://kph-os-operacao.vercel.app" },
  { prefixes: ["/compras", "/cardapio"], env: "COMPRAS_APP_URL", fallback: "https://kph-os-compras.vercel.app" },
  { prefixes: ["/comercial"], env: "COMERCIAL_APP_URL", fallback: "https://kph-os-ruptura.vercel.app" },
  { prefixes: ["/marca"], env: "MARCA_APP_URL", fallback: "https://kph-os-marca.vercel.app" },
  { prefixes: ["/inteligencia", "/orquestrador"], env: "INTELIGENCIA_APP_URL", fallback: "https://kph-os-inteligencia.vercel.app" },
] as const;
