...
import { requireUser, type CurrentUser } from "@maza/auth/server";
...
} from "@maza/db/types/compras-ingredientes";
...
async function resolveGroupId(user: CurrentUser): Promise<string | null> {
