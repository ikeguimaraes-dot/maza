...
export async function signIn(input: SignInInput): Promise<SignInResult> {
  ...
  if (data.session) {
    ...
    cookieStore.set("maza_auth_session_backup", encodedSession, {
      ...options, secure,
    });
    ...
    cookieStore.set("maza_access_token", data.session.access_token, {
      ...options, secure,
    });
    cookieStore.set("maza_refresh_token", data.session.refresh_token, {
      ...options, secure,
    });
  }
